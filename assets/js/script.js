document.addEventListener("DOMContentLoaded", function () {
  const navbar = document.querySelector(".header-upper");
  ...
  $(document).ready(function () {
    ...
    if ($(".partner-wrap").length) {
      $(".partner-wrap").slick({
        ...
        arrows: true,
        prevArrow:
          '<button class="partner-prev"><i class="fas fa-angle-double-right"></i></button>',
        nextArrow:
          '<button class="partner-next"><i class="fas fa-angle-double-left"></i></button>',
        pauseOnHover: false,
        autoplaySpeed: 2000,
        slidesToShow: 4,
        slidesToScroll: 1,
